  ...
  return (
    <div className="w-full py-[10rem] bg-white px-4">
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-100 w-full shadow-xl flex flex-col p-4 my-8 md:m-0 rounded-lg hover:scale-110 duration-300">
          <img
          ...
          <button className="text-[#00df9a] w-[20dvh] rounded-lg font-medium mx-auto md: my-5 py-3 bg-black">
            Start Trial
          </button>
        </div>
